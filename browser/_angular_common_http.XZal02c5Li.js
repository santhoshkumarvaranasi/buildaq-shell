    ...
    class e {
        ...
        doRequest(t, n, s) {
            return re(this, null, function* () {
                ...
                let d = new R(o.headers), a = o.statusText, f = Ie(o) ?? t.urlWithParams, y = o.status, p = null;
                if (t.reportProgress && s.next(new X({ headers: d, status: y, statusText: a, url: f })), o.body) {
                    let c = o.headers.get("content-length"), M = [], u = o.body.getReader(), h = 0, T, b, m = typeof Zone < "u" && Zone.current, P = !1;
                    if (yield this.ngZone.runOutsideAngular(() => re(this, null, function* () {
                        for (;;) {
                ...
                y === 0 && (y = p ? he : 0);
                let g = y >= 200 && y < 300, E = o.redirected;
                g ? (s.next(new _({ body: p, headers: d, status: y, statusText: a, url: f, redirected: E })), s.complete()) : s.error(new w({ error: p, headers: d, status: y, statusText: a, url: f, redirected: E }));
            });
        }
        parseBody(t, n, s, i) {
        ...
        createRequestInit(t) {
            let n = {}, s;
            if (s = t.credentials, t.withCredentials && (s = "include"), t.headers.forEach((i, o) => n[i] = o.join(",")), t.headers.has(q) || (n[q] = Be), !t.headers.has(z)) {
...
function Mt() {
    let e = null;
    return (r, t) => {
        e === null && (e = (v(pe, { optional: !0 }) ?? []).reduceRight(Pt, Xe));
        let n = v(xe);
        if (v(ye)) {
            let i = n.add();
...
var Z = (() => {
    ...
    return e;
})(), Ot = 0, _e, At = "JSONP injected script did not invoke callback.";
var Q = class {
};
    ...
    class e {
        ...
        handle(t) {
            ...
            return new le(n => {
                ...
                let f = () => { o.removeEventListener("load", y), o.removeEventListener("error", p), o.remove(), delete this.callbackMap[s]; }, y = () => {
                    this.resolvedPromise.then(() => {
                        if (f(), !a) {
                            n.error(new w({ url: i, status: 0, statusText: "JSONP Error", error: new Error(At) }));
                            return;
                        }
                        n.next(new _({ body: d, status: he, statusText: "OK", url: i })), n.complete();
                    });
                }, p = g => { f(), n.error(new w({ error: g, status: 0, statusText: "JSONP Error", url: i })); };
                return o.addEventListener("load", y), o.addEventListener("error", p), this.document.body.appendChild(o), n.next({ type: N.Sent }), () => { a || this.removeListeners(o), f(); };
            });
        }
...
var ae = (() => {
    class e {
        ...
        handle(t) {
            ...
            return (typeof ngServerMode < "u" && ngServerMode && n.ɵloadImpl ? mt(n.ɵloadImpl()) : Le(null)).pipe(pt(() => new le(i => {
                let o = n.build();
                if (o.open(t.method, t.urlWithParams), t.withCredentials && (o.withCredentials = !0), t.headers.forEach((u, h) => o.setRequestHeader(u, h.join(","))), t.headers.has(q) || o.setRequestHeader(q, Be), !t.headers.has(z)) {
                ...
                let d = t.serializeBody(), a = null, f = () => {
                    ...
                    return a = new X({ headers: h, status: o.status, statusText: u, url: T }), a;
                }, y = () => {
                    let { headers: u, status: h, statusText: T, url: b } = f(), m = null;
                    h !== wt && (m = typeof o.response > "u" ? o.responseText : o.response), h === 0 && (h = m ? he : 0);
                    let P = h >= 200 && h < 300;
                    if (t.responseType === "json" && typeof m == "string") {
                        let I = m;
                        m = m.replace(Dt, "");
                        try {
                    ...
                    P ? (i.next(new _({ body: m, headers: u, status: h, statusText: T, url: b || void 0 })), i.complete()) : i.error(new w({ error: m, headers: u, status: h, statusText: T, url: b || void 0 }));
    ...
    return e;
})(), H = new D(""), Ve = "XSRF-TOKEN", $e = new D("", { providedIn: "root", factory: () => Ve }), Ge = "X-XSRF-TOKEN", We = new D("", { providedIn: "root", factory: () => Ge }), B = class {
}, Ke = (() => {
    class e {
        doc;
        cookieName;
        ...
        getToken() {
            ...
            return t !== this.lastCookieString && (this.parseCount++, this.lastToken = be(t, this.cookieName), this.lastCookieString = t), this.lastToken;
        }
...
function Ye(e, r) {
    ...
    if (!v(H) || e.method === "GET" || e.method === "HEAD" || t.startsWith("http://") || t.startsWith("https://"))
        return r(e);
    let n = v(B).getToken(), s = v(We);
...
function qe(...e) {
    let r = [fe, ae, Z, { provide: j, useExisting: Z }, { provide: L, useFactory: () => v(ze, { optional: !0 }) ?? v(ae) }, { provide: J, useValue: Ye, multi: !0 }, { provide: H, useValue: !0 }, { provide: B, useClass: Ke }];
    for (let t of e)
        r.push(...t.ɵproviders);
    return ut(r);
}
...
var Ee = class extends zt {
    ...
    constructor(r, t, n, s, i) {
        super(t, ({ params: o, abortSignal: d }) => {
            ...
            let y = Jt({ value: void 0 }), p, g = new Promise(c => p = c), E = c => { y.set(c), p?.(y), p = void 0; };
            return a = this.client.request(o).subscribe({ next: c => {
                ...
                }, error: c => { c instanceof w && (this._headers.set(c.headers), this._statusCode.set(c.status)), E({ error: c }), d.removeEventListener("abort", f); }, complete: () => { p && E({ error: new at(991, !1) }), d.removeEventListener("abort", f); } }), g;
        }, n, i, r), this.client = r.get(fe);
    }
...
function tr(e, r) {
    let E = S(ve), { isCacheActive: t } = E, n = Re(E, ["isCacheActive"]), { transferCache: s, method: i } = e;
    if (!t || s === !1 || i === "POST" && !n.includePostRequests && !s || i !== "POST" && !er.includes(i) || !n.includeRequestsWithAuthHeaders && rr(e) || n.filter?.(e) === !1)
        return r(e);
    let o = S(Kt), d = S(Ht, { optional: !0 });
    if (typeof ngServerMode < "u" && !ngServerMode && d)
        throw new at(2803, !1);
    let a = typeof ngServerMode < "u" && ngServerMode && d ? ir(e.url, d) : e.url, f = sr(e, a), y = o.get(f, null), p = n.includeHeaders;
    if (typeof s == "object" && s.includeHeaders && (p = s.includeHeaders), y) {
    ...
    let g = r(e);
    return typeof ngServerMode < "u" && ngServerMode ? g.pipe(Zt(c => { c instanceof _ && o.set(f, { [et]: c.body, [tt]: nr(c.headers, p), [rt]: c.status, [nt]: c.statusText, [st]: a, [ot]: e.responseType }); })) : g;
}
