...
function j(t, n) {
    let e = t ? Pt(t) : void 0, r = n ? Pt(n) : void 0;
...
function Or(t, n, e) {
    if (!te(t.segments, n.segments) || !Ye(t.segments, n.segments, e) || t.numberOfChildren !== n.numberOfChildren)
        return !1;
...
var xt = class {
    ...
    parseChildren() {
        ...
        let r = {};
        return this.peekStartsWith("(") && (r = this.parseParens(!1)), (n.length > 0 || Object.keys(e).length > 0) && (r[d] = new v(n, e)), r;
    }
    parseSegment() {
        let n = Et(this.remaining);
        if (n === "" && this.peekStartsWith(";"))
            throw new I(4009, !1);
        return this.capture(n), new Q(Je(n), this.parseMatrixParams());
    }
    parseMatrixParams() {
        let n = {};
...
function jr(t, n, e, r) {
    ...
    let o = mi(n);
    if (o.toRoot())
        return Ot(i, i, new v([], {}), e, r);
    let s = Ri(o, i, t), a = s.processChildren ? Ee(s.segmentGroup, s.index, o.commands) : $r(s.segmentGroup, s.index, o.commands);
    return Ot(i, s.segmentGroup, a, e, r);
}
...
var tt = class {
    ...
    commands;
    constructor(n, e, r) {
        if (this.isAbsolute = n, this.numberOfDoubleDots = e, this.commands = r, n && r.length > 0 && et(r[0]))
            throw new I(4003, !1);
        let i = r.find(Ne);
        if (i && i !== Tr(r))
            throw new I(4004, !1);
...
function Ri(t, n, e) {
    if (t.isAbsolute)
        return new de(n, !0, 0);
    if (!e)
        return new de(n, !1, NaN);
    if (e.parent === null)
        return new de(e, !0, 0);
    let r = et(t.commands[0]) ? 0 : 1, i = e.segments.length - 1 + r;
    return yi(e, i, t.numberOfDoubleDots);
}
function yi(t, n, e) {
    let r = t, i = n, o = e;
    for (; o > i;) {
...
function $r(t, n, e) {
    if (t ??= new v([], {}), t.segments.length === 0 && t.hasChildren())
        return Ee(t, n, e);
    let r = Ci(t, n, e), i = e.slice(r.commandIndex);
...
var Br = new ie(""), Yt = (() => {
    class t {
        ...
        activateWith(e, r) {
            ...
            let i = this.location, s = e.snapshot.component, a = this.parentContexts.getOrCreateContext(this.name).children, u = new zt(e, a, i.injector, this.routerOutletData);
    ...
    class t {
        ...
        subscribeToRouteData(e) {
            let { activatedRoute: r } = e, i = Wt([r.queryParams, r.params, r.data]).pipe(E(([o, s, a], u) => (a = h(h(h({}, o), s), a), u === 0 ? f(a) : Promise.resolve(a)))).subscribe(o => {
...
var Ni = (t, n, e, r) => R(i => (new Ft(n, i.targetRouterState, i.currentRouterState, e, r).activate(t), i)), Ft = class {
    ...
    detachAndStoreRouteSubtree(n, e) {
        let r = e.getContext(n.value.outlet), i = r && n.value.component ? r.children : e, o = le(n);
...
function _i(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) {
    ...
    if (s && o.routeConfig === s.routeConfig) {
        ...
        s && Oe(n, a, i), i.canActivateChecks.push(new vt(r)), o.component ? Ie(t, null, a ? a.children : null, r, i) : Ie(t, null, e, r, i);
    return i;
}
function xi(t, n, e) {
...
function Se() {
    return E(t => Wt(t.map(n => n.pipe(De(1), Yn(Ke)))).pipe(R(n => {
        for (let e of n)
            if (e !== !0) {
                if (e === Ke)
                    return Ke;
...
function Qi(t, n, e) {
    ...
    if (!r || r.length === 0)
        return f(!0);
    let i = r.map(o => Qt(() => { let s = Ce(n) ?? e, a = we(o, s), u = ki(a) ? a.canActivate(n, t) : x(s, () => a(n, t)); return H(u).pipe(oe()); }));
    return f(i).pipe(Se());
}
...
function Yi(t, n, e, r, i) {
    ...
    if (!o || o.length === 0)
        return f(!0);
    let s = o.map(a => { let u = Ce(n) ?? i, c = we(a, u), g = zi(c) ? c.canDeactivate(t, n, e, r) : x(u, () => c(t, n, e, r)); return H(g).pipe(oe()); });
    return f(s).pipe(Se());
}
function Zi(t, n, e, r) {
    let i = n.canLoad;
    if (i === void 0 || i.length === 0)
        return f(!0);
    let o = i.map(s => { let a = we(s, t), u = ji(a) ? a.canLoad(n, e) : x(t, () => a(n, e)); return H(u); });
    return f(o).pipe(Se(), Qr(r));
}
function Qr(t) {
    return Wn(C(n => {
        if (typeof n != "boolean")
...
function Ji(t, n, e, r) {
    ...
    if (!i || i.length === 0)
        return f(!0);
    let o = i.map(s => { let a = we(s, t), u = Fi(a) ? a.canMatch(n, e) : x(t, () => a(n, e)); return H(u); });
    return f(o).pipe(Se(), Qr(r));
}
var je = class {
    segmentGroup;
...
function to(t, n, e) {
    if (typeof t == "string")
        return f(t);
    let r = t, { queryParams: i, fragment: o, routeConfig: s, url: a, outlet: u, params: c, data: g, title: S } = n;
    return H(x(e, () => r({ params: c, data: g, queryParams: i, fragment: o, routeConfig: s, url: a, outlet: u, title: S })));
}
...
function Kr(t, n, e) {
    if (n.path === "**")
        return no(e);
    if (n.path === "")
        return n.pathMatch === "full" && (t.hasChildren() || e.length > 0) ? h({}, Bt) : { matched: !0, consumedSegments: [], remainingSegments: e, parameters: {}, positionalParamSegments: {} };
    let i = (n.matcher || Ir)(e, t, n);
    if (!i)
        return h({}, Bt);
    let o = {};
...
var lo = 31, Vt = class {
    ...
    match(n) {
        let e = new re([], Object.freeze({}), Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, Object.freeze({}), d, this.rootComponentType, null, {});
        return this.processSegmentGroup(this.injector, this.config, n, d, e).pipe(R(r => ({ children: r, rootSnapshot: e })), Te(r => {
            if (r instanceof ke)
                return this.urlTree = r.urlTree, this.match(r.urlTree.root);
            throw r instanceof je ? this.noMatchError(r) : r;
        }));
    }
    ...
    processChildren(n, e, r, i) {
        ...
        return $(o).pipe(Xe(s => { let a = r.children[s], u = Ai(e, s); return this.processSegmentGroup(n, u, a, s, i); }), Zn((s, a) => (s.push(...a), s)), Cr(null), Jn(), _(s => {
            if (s === null)
                return ce(r);
            let a = Yr(s);
            return ho(a), f(a);
    ...
    processSegment(n, e, r, i, o, s, a) {
        return $(e).pipe(Xe(u => this.processSegmentAgainstRoute(u._injector ?? n, e, u, r, i, o, s, a).pipe(Te(c => {
            if (c instanceof je)
                return f(null);
            throw c;
        }))), oe(u => !!u), Te(u => {
            if (Wr(u))
                return uo(r, i, o) ? f(new Ht) : ce(r);
            throw u;
        }));
    }
    ...
    expandSegmentAgainstRouteUsingRedirect(n, e, r, i, o, s, a) {
        let { matched: u, parameters: c, consumedSegments: g, positionalParamSegments: S, remainingSegments: D } = Kr(e, i, o);
        if (!u)
            return ce(e);
        typeof i.redirectTo == "string" && i.redirectTo[0] === "/" && (this.absoluteRedirectCount++, this.absoluteRedirectCount > lo && (this.allowRedirects = !1));
        let G = new re(o, c, Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, Rr(i), P(i), i.component ?? i._loadedComponent ?? null, i, yr(i)), A = pt(G, a, this.paramsInheritanceStrategy);
        return G.params = Object.freeze(A.params), G.data = Object.freeze(A.data), this.applyRedirects.applyRedirectCommands(g, i.redirectTo, S, G, n).pipe(E(ee => this.applyRedirects.lineralizeSegments(i, ee)), _(ee => this.processSegment(n, r, e, ee.concat(D), s, !1, a)));
    }
    matchSegmentAgainstRoute(n, e, r, i, o, s) {
        let a = ro(e, r, i, n, this.urlSerializer);
        return r.path === "**" && (e.children = {}), a.pipe(E(u => u.matched ? (n = r._injector ?? n, this.getChildConfig(n, r, i).pipe(E(({ routes: c }) => {
            let g = r._loadedInjector ?? n, { parameters: S, consumedSegments: D, remainingSegments: G } = u, A = new re(D, S, Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, Rr(r), P(r), r.component ?? r._loadedComponent ?? null, r, yr(r)), ue = pt(A, s, this.paramsInheritanceStrategy);
            A.params = Object.freeze(ue.params), A.data = Object.freeze(ue.data);
            let { segmentGroup: ee, slicedSegments: Tt } = mr(e, D, G, c);
            if (Tt.length === 0 && ee.hasChildren())
                return this.processChildren(g, c, ee, A).pipe(R(Ge => new T(A, Ge)));
            if (c.length === 0 && Tt.length === 0)
                return f(new T(A, []));
            let Tn = P(r) === o;
            return this.processSegment(g, c, ee, Tt, Tn ? d : o, !0, A).pipe(R(Ge => new T(A, Ge instanceof T ? [Ge] : [])));
        }))) : ce(e)));
    }
        ...
        for (let u of o)
            if (!s.has(u))
                for (let c of Zr(u))
                    s.add(c);
        let a = 0;
        return $(s).pipe(Xe(u => o.has(u) ? vo(u, r, t, n) : (u.data = pt(u, u.parent, t).resolve, f(void 0))), C(() => a++), wr(1), _(u => a === s.size ? f(e) : W));
    });
}
...
function mo(t, n, e, r) {
    ...
    if (i.length === 0)
        return f({});
    let o = {};
    return $(i).pipe(_(s => Ro(t[s], n, e, r).pipe(oe(), C(a => {
        if (a instanceof ye)
            throw gt(new K, a);
        o[s] = a;
    }))), wr(1), R(() => o), Te(s => Wr(s) ? W : Rt(s)));
}
...
var er = (() => {
    class t {
        buildTitle(e) {
            let r, i = e.root;
            for (; i !== void 0;)
                r = this.getResolvedTitleForRoute(i) ?? r, i = i.children.find(o => o.outlet === d);
            return r;
        }
    ...
    return t;
})(), V = new ie("", { providedIn: "root", factory: () => ({}) }), X = new ie(""), St = (() => {
    class t {
        ...
        loadComponent(e, r) {
            ...
            let i = H(x(e, () => r.loadComponent())).pipe(R(en), E(tn), C(s => { this.onLoadEndListener && this.onLoadEndListener(r), r._loadedComponent = s; }), Nt(() => { this.componentLoaders.delete(r); })), o = new lr(i, () => new Me).pipe(hr());
        ...
        loadChildren(e, r) {
            ...
            this.onLoadStartListener && this.onLoadStartListener(r);
            let o = Xr(r, this.compiler, e, this.onLoadEndListener).pipe(Nt(() => { this.childrenLoaders.delete(r); })), s = new lr(o, () => new Me).pipe(hr());
...
function rn(t, n, e) {
    let r = t.get(rr), i = t.get(En);
    if (!i.startViewTransition || r.skipNextTransition)
        return r.skipNextTransition = !1, new Promise(c => setTimeout(c));
    let o, s = new Promise(c => { o = c; }), a = i.startViewTransition(() => (o(), Co(t)));
    a.ready.catch(c => { });
    let { onViewTransitionCreated: u } = r;
    return u && x(t, () => u({ transition: a, from: n, to: e })), s;
}
...
var wt = new ie(""), qe = (() => {
    class t {
        ...
        setupNavigations(e) {
            return this.transitions = new U(null), this.transitions.pipe(he(r => r !== null), E(r => {
                let i = !1;
                return f(r).pipe(E(o => {
                    if (this.navigationId > r.id)
                        return this.cancelNavigationTransition(r, "", w.SupersededByNewNavigation), W;
                    this.currentTransition = r, this.currentNavigation.set({ id: o.id, initialUrl: o.rawUrl, extractedUrl: o.extractedUrl, targetBrowserUrl: typeof o.extras.browserUrl == "string" ? this.urlSerializer.parse(o.extras.browserUrl) : o.extras.browserUrl, trigger: o.source, extras: o.extras, previousNavigation: this.lastSuccessfulNavigation ? N(h({}, this.lastSuccessfulNavigation), { previousNavigation: null }) : null, abort: () => o.abortController.abort() });
                    ...
                    if (s && this.urlHandlingStrategy.shouldProcessUrl(o.currentRawUrl)) {
                        ...
                        return this.events.next(new F(o.id, this.urlSerializer.serialize(o.extractedUrl), "", ge.IgnoredByUrlHandlingStrategy)), o.resolve(!1), W;
                }), C(o => { let s = new rt(o.id, this.urlSerializer.serialize(o.extractedUrl), this.urlSerializer.serialize(o.urlAfterRedirects), o.targetSnapshot); this.events.next(s); }), R(o => (this.currentTransition = r = N(h({}, o), { guards: Ui(o.targetSnapshot, o.currentSnapshot, this.rootContexts) }), r)), Bi(this.environmentInjector, o => this.events.next(o)), C(o => {
                    if (r.guardsResult = o.guardsResult, o.guardsResult && typeof o.guardsResult != "boolean")
                        throw gt(this.urlSerializer, o.guardsResult);
                    let s = new nt(o.id, this.urlSerializer.serialize(o.extractedUrl), this.urlSerializer.serialize(o.urlAfterRedirects), o.targetSnapshot, !!o.guardsResult);
                    this.events.next(s);
                }), he(o => o.guardsResult ? !0 : (this.cancelNavigationTransition(o, "", w.GuardRejected), !1)), Dt(o => {
...
var Ao = { paths: "exact", fragment: "ignored", matrixParams: "ignored", queryParams: "exact" }, To = { paths: "subset", fragment: "ignored", matrixParams: "ignored", queryParams: "subset" }, L = (() => {
    class t {
        ...
        navigateToSyncWithBrowser(e, r, i) {
            ...
            this.scheduleNavigation(a, r, s, o).catch(u => { this.disposed || this.injector.get(qn)(u); });
        }
        ...
        createUrlTree(e, r = {}) {
            let { relativeTo: i, queryParams: o, fragment: s, queryParamsHandling: a, preserveFragment: u } = r, c = u ? this.currentUrlTree.fragment : s, g = null;
        ...
        isActive(e, r) {
            let i;
            if (r === !0 ? i = h({}, Ao) : r === !1 ? i = h({}, To) : i = r, Y(e))
                return fr(this.currentUrlTree, e, i);
            let o = this.parseUrl(e);
            return fr(this.currentUrlTree, o, i);
        }
...
var At = (() => {
    class t {
        ...
        subscribeToNavigationEventsIfNecessary() {
            ...
            e ||= r(this.queryParamsHandling), e ||= !this.queryParamsHandling && !r(this.options?.defaultQueryParamsHandling), e && (this.subscription = this.router.events.subscribe(i => { i instanceof M && this.updateHref(); }));
        }
        preserveFragment = !1;
    ...
    class t {
        ...
        static ɵdir = l.ɵɵdefineDirective({ type: t, selectors: [["", "routerLinkActive", ""]], contentQueries: function (r, i, o) {
                if (r & 1 && l.ɵɵcontentQuery(o, At, 5), r & 2) {
                    let s;
    ...
    class t {
        ...
        preloadConfig(e, r) {
            return this.preloadingStrategy.preload(r, () => {
                ...
                let o = i.pipe(Ho(s => s === null ? ae(void 0) : (r._loadedRoutes = s.routes, r._loadedInjector = s.injector, this.processRoutes(s.injector ?? e, s.routes))));
...
function mn() {
    ...
    return n => {
        ...
        if (n !== e.components[0])
            return;
        let r = t.get(L), i = t.get(Rn);
        t.get(ur) === 1 && r.initialNavigation(), t.get(Cn, null, { optional: !0 })?.setUpPreloading(), t.get(ar, null, { optional: !0 })?.init(), r.resetRootComponentType(e.componentTypes[0]), i.closed || (i.next(), i.complete(), i.unsubscribe());
    };
}
...
var An = [Mo, { provide: J, useClass: K }, L, se, { provide: q, useFactory: vn, deps: [L] }, St, []], rs = (() => {
    class t {
        constructor() { }
